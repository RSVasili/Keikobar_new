...
namespace Keikobar.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        // private readonly IUserLoginStore<IdentityUser> _loginStore;
        ...
        public RegisterModel(
            ...
            // IUserPhoneNumberStore<IdentityUser> phoneNumberStore,
            // IUserLoginStore<IdentityUser> loginStore,
            RoleManager<IdentityRole> roleManager)
        {
            // _loginStore = loginStore;
            // _phoneNumberStore = phoneNumberStore;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // await _loginStore.SetNormalizedUserNameAsync(user, Input.Login, CancellationToken.None);
